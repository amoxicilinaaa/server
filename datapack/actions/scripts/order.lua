...
if getCreatureCondition(cid, CONDITION_OUTFIT) and (item2.uid == cid or getRecorderPlayer(topos) == cid) and (getPlayerStorageValue(cid, 17000) >= 1 or getPlayerStorageValue(cid, 17001) >= 1) then
	...
	if getPlayerLevel(cid) <= 99 then doChangeSpeed(cid, 1160)
doChangeSpeed(cid, -660)
elseif getPlayerLevel(cid) <= 199 then
doChangeSpeed(cid, -160)
elseif getPlayerLevel(cid) <= 299 then ---- aqui tu pega a speed do level e subtrai pella speed do seu fly/ride tipo  o meu e 1160 ai to aqui no lvl 299 o lvl 299 tem 1500 de speed no login ou seja falta 340 pra atingir 1500 saca
doChangeSpeed(cid, 340)
elseif getPlayerLevel(cid) <= 399 then
doChangeSpeed(cid, 840)
elseif getPlayerLevel(cid) <= 499 then
doChangeSpeed(cid, 1340)
elseif getPlayerLevel(cid) <= 599 then
doChangeSpeed(cid, 1840)
elseif getPlayerLevel(cid) <= 699 then
doChangeSpeed(cid, 2340)
elseif getPlayerLevel(cid) <= 799 then
doChangeSpeed(cid, 2840)
elseif getPlayerLevel(cid) <= 899 then
doChangeSpeed(cid, 3340)
end
...
if dittoCopiesStatusToo then
   ...
   setPlayerStorageValue(mysum, 1003)
