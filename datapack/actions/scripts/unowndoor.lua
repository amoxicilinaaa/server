local cfg = {
    failpos = {x = 891, y = 2722, z = 7}, -- Posição caso não tenha um dos requerimentos.
    pos = {x = 892, y = 2728, z = 8},     -- Posição caso tenha todos os requerimentos.
    vocations = {1, 4},                 -- ID's das vocations, separe por vírgulas!
    item = {2087, 1},                  -- ID/count.
