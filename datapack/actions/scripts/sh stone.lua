...
PokemonShinys = 
{
	...
	["Gardevoir"] = {name = "Shiny Gardevoir", quant = 9},
	["Lucario"] = {name = "Shiny Lucario", quant = 7},
	["Sandslash"] = {name = "Shiny Sandslash", quant = 4},
	["Primeape"] = {name = "Shiny Primeape", quant = 4},
	["Weezing"] = {name = "Shiny Weezing", quant = 5},
	["Gloom"] = {name = "Shiny Gloom", quant = 2},
	["Gallade"] = {name = "Shiny Gallade", quant = 8},
	["Absol"] = {name = "Shiny Absol", quant = 7},
	["Noctowl"] = {name = "Shiny Noctowl", quant = 7},
	["Quagsire"] = {name = "Shiny Quagsire", quant = 6},
	["Wobbuffet"] = {name = "Shiny Wobbuffet", quant = 7},
	["Camerupt"] = {name = "Shiny Camerupt", quant = 7},
	["Claydol"] = {name = "Shiny Claydol", quant = 7},
	["Probopass"] = {name = "Shiny Probopass", quant = 8},
	["Swellow"] = {name = "Shiny Swellow", quant = 7},
}
