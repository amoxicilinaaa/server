...
storage = 1147855 -- A CADA BAU AUMENTA 1 NUMERO, 1147852, 1147853, 1147854 ...
item = 12151 -- Id do item ira ganhar.
nomeitem = "Red Feather" -- Nome do item
quantidade = 1 -- Quantidade ira ganhar.
level = 550 -- Level que precisa pra fazer.
...
doPlayerAddItem(cid, 2160, 5) -- Não mecha.
