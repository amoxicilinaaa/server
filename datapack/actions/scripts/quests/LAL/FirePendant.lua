...
storage = 8264791 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 12286 -- Id do item ira ganhar.
nomeitem = "Fire Pendant" -- Nome do item
...
doPlayerSendTextMessage(cid,25,"Você encontrou um item escondido na estátua.") -- Mensagem que aparecera quando ganhar o item.
