...
storage = 5347249 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 13261 -- Id do item ira ganhar.
nomeitem = "Gaia Tentacles" -- Nome do item
...
doPlayerSendTextMessage(cid,25,"Parabéns! Você encontrou 10x Gaia Tentacles.") -- Mensagem que aparecera quando ganhar o item.
doPlayerAddItem(cid, item, quantidade) -- Não mecha.
doPlayerAddItem(cid, 14078, 1)
setPlayerStorageValue(cid,storage,1) -- Não mecha.

elseif getPlayerLevel(cid) <= level then -- Não mecha
doPlayerSendTextMessage(cid,25,"Você precisa ser nível "..level.." ou mais para pegar o item escondido.") -- Mensagem que ira aparecer se o player tiver menos level que o necessario.
