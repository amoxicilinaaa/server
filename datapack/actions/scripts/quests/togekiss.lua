local pos_room = {x=1229,y=2375,z=8} 
local radius = 11 
local Premio = {x=1229, y=2362, z=8}
...
function onUse(cid,item,pos) 
   ...
   doPlayerSendTextMessage(cid, 26, "Derrote todos o Boss Metagross para poder passar para seu premio ou reculha os pokemon para ball")
   return true 
end