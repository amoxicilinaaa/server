...
storage = 2353466 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 12618 -- Id do item ira ganhar.
nomeitem = "Boost Stone" -- Nome do item
quantidade = 1 -- Quantidade ira ganhar.
level = 149 -- Level que precisa pra fazer.
