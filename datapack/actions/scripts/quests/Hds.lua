...
storage = 4234563 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 2152 -- Id do item ira ganhar.
nomeitem = "20 HDS" -- Nome do item
