...
storage = 2353465 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 11443 -- Id do item ira ganhar.
nomeitem = "Venom Stone" -- Nome do item
quantidade = 6 -- Quantidade ira ganhar.
