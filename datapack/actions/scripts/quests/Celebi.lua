...
doBroadcastMessage("o "..getCreatureName(cid).." esta tentando fazer a quest Celebi ilegalmente")
return true
end
storage = 20112016 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 11115 -- Id do item ira ganhar.
nomeitem = "Heart backpack" -- Nome do item
