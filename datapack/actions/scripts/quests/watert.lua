...
storage = 31441546 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 11442 -- Id do item ira ganhar.
nomeitem = "Water Stone" -- Nome do item
quantidade = 1 -- Quantidade ira ganhar.
level = 25 -- Level que precisa pra fazer.
