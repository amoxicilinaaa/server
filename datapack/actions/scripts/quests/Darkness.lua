...
storage = 2353462 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 11450 -- Id do item ira ganhar.
nomeitem = "Darkness Stone" -- Nome do item
