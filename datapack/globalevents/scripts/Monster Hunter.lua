local monsters = { "Rattata", "Magikarp", "Rattata", "Alakazam", "Gengar", "Rattata", "Lapras", "Charizard", "Venusaur", "Caterpie", "Horsea", "Charizard", "Gloom"} -- Monstros que podem ser sorteados
