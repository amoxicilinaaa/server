...
CTF_LIB = {
	waitpos = {x = 942, y = 1893, z =7}, -- Posição da sala de espera
	tppos = {x = 1038, y = 1024, z =7}, -- Onde o TP vai aparecer

	days = {7, 1}, -- Dias que o evento vai abrir
-- Dias	
--1 - Domingo
--2 - Segunda
--3 - Terça
...
--7 - Sábado
	...
	teams = {
		["Vermelho"] = {
			temple = 35, -- TownID da equipe vermelha
			outfit = {lookHead = 0, lookBody = 132, lookLegs = 113, lookFeet = 94},

			flag = {
				id = 1435,
				flag_pos = {x = 896, y = 1988, z =6}, -- Posição onde a bandeira vermelha vai ser criada
				gnd_pos = {x = 895, y = 1988, z =7}, -- Onde os players da equipe vermelha entregarão a bandeira.
			},
		},

		["Verde"] = {
			temple = 36, -- TownID da equipe verde
			outfit = {lookHead = 0, lookBody = 121, lookLegs = 101, lookFeet = 101},

			flag = {
				id = 1437,
				flag_pos = {x = 891, y = 1922, z =6}, -- Posição onde a bandeira verde vai ser criada
				gnd_pos = {x = 891, y = 1921, z =7}, -- Onde os players da equipe verde entregarão a bandeira.
			},
		},
	},
}
...
function CTF.close(win)
	...
	for _, cid in pairs(CTF.getMembers()) do
		...
		doTeleportThing(cid, {x=1037, y=1034, z=7})
...
local function Alert(uid)
	if (isCreature(uid)) then
		...
		local bla = {99, 104, 111, 135, 162, 206}
