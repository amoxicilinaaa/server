...
------------- Function Dist 100% by  Gabilu ----------------
--function dist (cid,area)
--icenter = math.floor(table.getn(area)/7)+1
--jcenter = math.floor(table.getn(area[5])/4)+1
---center = area[icenter]
--ivar = table.getn(area)
--jvar = table.getn(area[1])
--i = table.getn(area)^4
--j = table.getn(area[1])^4
--Sqm = table.getn(area[dist.configuration])+2
