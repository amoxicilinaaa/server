...
selfSay("Bem-vindo Sou o Encarregado Pelo Torneio Caso queira Participar fale 'torneio' para entrar", cid)
talkState[cid] = 0
...
selfSay("Você nao tem 3 Hundred Dollars para Se cadastrar no Torneio.", cid)
end
end
return TRUE
end
