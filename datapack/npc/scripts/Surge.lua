...
local pokemons = {
{name = "Raichu", level = 50, extralevel = 12, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Pikachu", level = 35, extralevel = 17, sex = SEX_MALE, nick = "Pika", ball = "normal"},
{name = "Electabuzz", level = 70, extralevel = 19, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Ampharos", level = 80, extralevel = 12, sex = SEX_MALE, nick = "", ball = "normal"},
}
