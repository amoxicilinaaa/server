...
segundaHistoria = "Bom eu cobro os seguinte items Iman, Dragon scale,hook", -- História que o npc vai contar após o player dizer as palavras acima
...
finalHistory = "Obirgado, aki esta sua roupa!", -- Oque o npc vai falar depois que trocar
...
selfSay('Ola '..getCreatureName(cid)..' quer comprar uma roupa de frio?',config.talkType)
end
...
selfSay('Obirgado, aki esta sua roupa!')
