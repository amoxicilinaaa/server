...
if isSummon(attacker) or isPlayer(attacker) then
   if canAttackOther(cid, attacker) == "Cant" then return false end
    ...
    if valor >= getCreatureHealth(cid) then
       ...
       doPlayerSendTextMessage(cid,MESSAGE_EVENT_ORANGE,"Voce agora tem "..(getPlayerStorageValue(cid,19998) + 1).." LOSE SCORES.") 
       setPlayerStorageValue(cid,19998,getPlayerStorageValue(cid,19998)+1)
          ...
          doPlayerSendTextMessage(getCreatureMaster(attacker),MESSAGE_EVENT_ORANGE,"Voce agora tem "..(getPlayerStorageValue(getCreatureMaster(attacker),19999) + 1).." WIN SCORES.")   
          doSendAnimatedText(getCreaturePosition(cid),"WIINN",math.random(1,255))
        end
