...
class LuaScriptInterface
{
	...
	protected:
		...
		static int32_t luaGetPlayerPrivateChannelId(lua_State* L);
		static int32_t luaDoPlayerCreatePrivateChannel(lua_State* L);
		static int32_t luaDoPlayerCreateChannel(lua_State* L);
		static int32_t luaDoPlayerOpenChannel(lua_State* L);
		static int32_t luaDoPlayerCloseChannel(lua_State* L);
		
		static int32_t luaSetPokeAddon(lua_State* L);
		static int32_t luaGetPlayerDuel(lua_State* L);
		static int32_t luaDoPlayerInviteDuel(lua_State* L);
		static int32_t luaDoPlayerJoinDuel(lua_State* L);
		static int32_t luaGetDuelMembers(lua_State* L);
		static int32_t luaDoOkDuel(lua_State* L);
		static int32_t luaGetPoDuel(lua_State* L);
		static int32_t luaSetPoDuel(lua_State* L);
		static int32_t luaDoCancelDuel(lua_State* L);
        static int32_t luaGetOutfitPoke(lua_State* L);
		...
		static int32_t luaMovesPokeClient(lua_State* L);
		
        static int32_t luaWalkToPos(lua_State* L);
        static int32_t luaCanMonsterWalkTo(lua_State* L);
    	static int32_t luaGetCreatureStat(lua_State* L);
    	static int32_t luaSetCreatureStat(lua_State* L);
    	
    	static int32_t luaDoAutoLoot(lua_State* L);
		static int32_t luaGetItemIdByClientId(lua_State* L);
		static int32_t luaDoEraseMarket(lua_State* L);
		static int32_t luaDoSellMarket(lua_State* L);
		static int32_t luaDoBuyMarket(lua_State* L);
		static int32_t luaDoCancelMarket(lua_State* L);
		static int32_t luaGetDesMarket(lua_State* L);
		
		static int32_t luaDoUpdateFly(lua_State* L);
		
		//TV Viktor
		static int32_t luaSetCreateTvChanel(lua_State* L);
		static int32_t luaGetAllsTvWatch(lua_State* L);
		static int32_t luaSetPlayerTvWatch(lua_State* L);
		static int32_t luaDoSendChannelsTv(lua_State* L);
		static int32_t luaPlayerHasTv(lua_State* L);
		static int32_t luaDoCloseChannelTv(lua_State* L);
		static int32_t luaDoLeaveTvChannel(lua_State* L); 
		static int32_t luaGetChannelOwner(lua_State* L);
		
		
		static int32_t luaSetPvpArenaBans(lua_State* L);
		static int32_t luaGetPvpArenaBans(lua_State* L);
		static int32_t luaSetPvpArenaPicks(lua_State* L);
		static int32_t luaGetPvpArenaPicks(lua_State* L);
		static int32_t luaSetPvpArenaEnemy(lua_State* L);
		static int32_t luaGetPvpArenaEnemy(lua_State* L);
		static int32_t luaGetPvpArenaEnemyList(lua_State* L);
		static int32_t luaSetPvpArenaEnemyList(lua_State* L);
		static int32_t luaRemovePvpArenaEnemyList(lua_State* L);
		static int32_t luaRemovePvpArenaBans(lua_State* L);
		static int32_t luaRemovePvpArenaPicks(lua_State* L);
		static int32_t luaGetPvpArenaDepot(lua_State* L);
		static int32_t luaMovePvpDepotToBag(lua_State* L);
		static int32_t luaDoErasePvpArenaDepot(lua_State* L);
		
		
		static int32_t luaSetEditMode(lua_State* L);    
		...
		static int32_t luaDoCreatureSetPesca(lua_State* L);
		...
		static int32_t luaGetDirectionToWalk(lua_State* L);
		...
		static int32_t luaGetPlayerPokeballsCount(lua_State* L);
		...
		static int32_t luaGetDamageMapPercent(lua_State* L); // adicionado
		...
		static int32_t luaGetCreatureSetNick(lua_State* L);		
		static int32_t luaDoAddPlayerBanishment(lua_State* L);
        static int32_t luaDoSetMonsterPassive(lua_State* L);
		...
		static int32_t luaGetPlayerExperienceLevel(lua_State* L); 
		...
		static int32_t luaDoPlayerSendCustomChannelList(lua_State* L);
		...
		static int32_t luaGetDepotItem(lua_State* L);
		...
		static int32_t luaDoAttackPokemon(lua_State* L);
		...
		static int32_t luaDoPlayerGetAutoLootItem(lua_State* L);
		static int32_t luaGetPlayerAutoLootList(lua_State* L);
		
		//Viktor
		static int32_t luaGetPlayerCatch(lua_State* L);
		static int32_t luaSetPlayerCatch(lua_State* L);
		static int32_t luaGetPlayerCatchCount(lua_State* L);
		static int32_t luaSetPlayerCatchCount(lua_State* L);
		...
		static int32_t luaDoPlayerSendPokeCPName(lua_State* L); //viktor system
