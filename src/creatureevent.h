...
enum CreatureEventType_t
{
	...
	CREATURE_EVENT_SELECTTV, //TV Viktor
	CREATURE_EVENT_CAST,
	CREATURE_EVENT_KILL,
...
class CreatureEvent : public Event
{
	public:
		...
		uint32_t executeOpenChannel(Player* player, uint16_t channelId);
		...
		uint32_t executeSelectTv(Player* player, uint16_t id); //TV Viktor
