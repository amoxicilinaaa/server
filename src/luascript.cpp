...
bool LuaScriptInterface::loadDirectory(const std::string& dir, Npc* npc/* = NULL*/)
{
	...
	{
		//std::string s = it->leaf(); // windows
		std::string s = it->path().filename().string(); // linux
...
void LuaScriptInterface::registerFunctions()
{
	...
	// lua_register(m_luaState, "sendMarketItem", LuaScriptInterface::luaDoSendMarketItem);
	...
	// lua_register(m_luaState, "sendMarketRemovePlayerItem", LuaScriptInterface::luaDoRemovePlayerMarketItem);

	// //sendMarketCancelOffer(cid, numeration) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketCancelOffer", LuaScriptInterface::luaDoCancelPlayerMarketItem);

	// //sendMarketMyOffers(cid) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketMyOffers", LuaScriptInterface::luaDoOpenMarketSellerInsertMyOffers);

	// //sendMarketAllOffers(cid) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketAllOffers", LuaScriptInterface::luaDoOpenMarketBuyInsertAllOffers);

	// //sendMarketBuyOffer(cid, price, transaction_id, countSelectedScrollbar) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketBuyOffer", LuaScriptInterface::luaDoMarketBuyOffer);

	// //sendMarketMyHistoric(cid) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketMyHistoric", LuaScriptInterface::luaDoMarketMyHistoric);

	// //sendMarketMakeOfferRemoveItem(cid, index, transaction_id) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketMakeOfferRemoveItem", LuaScriptInterface::luaDoMarketMakeOfferRemoveItem);

	// //sendMarketMakeOffer(cid, transaction_id, item_seller, index) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketMakeOfferConfirm", LuaScriptInterface::luaDoMarketMakeOfferConfirm);

	// //sendMarketViewYourOffers(cid) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketViewYourOffers", LuaScriptInterface::luaDoOpenMarketViewYourOffers);

	// //sendMarketViewAllSlotsOffers(cid, transaction_id) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketViewAllSlotsOffers", LuaScriptInterface::luaDoOpenMarketInsertAllOffersInSlots);

	// //sendMarketViewAllSlotsOffersToMe(cid, transaction_id) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketViewAllSlotsOffersToMe", LuaScriptInterface::luaDoOpenMarketInsertAllOffersToMeInSlots);
			
	// //sendMarketCancelYourOfferBackBuyer(cid, transaction_id) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketCancelYourOfferBackBuyer", LuaScriptInterface::luaDoMarketCancelYourOfferBackBuyer);

	// //sendMarketViewOffersToYou(cid) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketViewOffersToYou", LuaScriptInterface::luaDoMarketViewOffersToMe);

	// //sendMarketConfirmOfferToMe(cid, transaction_id) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketConfirmOfferToMe", LuaScriptInterface::luaDoMarketOfferConfirmToMe);

	// //sendMarketReedemMyItemsOffer(cid) // Thalles Vitor - Market System
	// lua_register(m_luaState, "sendMarketReedemMyItemsOffer", LuaScriptInterface::luaDoMarketReedemMyOffers);

	// //sendMarketChangeOption(cid, value)
	// lua_register(m_luaState, "sendMarketChangeOption", LuaScriptInterface::luaDoMarketChangeOption);
	
	// //sendMarketChangePage(cid, type, category)
	// lua_register(m_luaState, "sendMarketChangePage", LuaScriptInterface::luaDoMarketChangePage);
	
	// //sendMarketSearch(cid, type, category)
	// lua_register(m_luaState, "sendMarketSearch", LuaScriptInterface::luaDoMarketSearch);
