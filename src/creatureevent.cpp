...
bool CreatureEvent::configureEvent(xmlNodePtr p)
{
	...
	else if(tmpStr == "openchannel")
		m_type = CREATURE_EVENT_OPEN_CHANNEL;
	...
	else if(tmpStr == "selecttv") //TV Viktor
...
std::string CreatureEvent::getScriptEventName() const
{
	switch(m_type)
	{
		...
		case CREATURE_EVENT_OPEN_CHANNEL:
		...
		case CREATURE_EVENT_SELECTTV: //TV Viktor
			return "onSelectTv";
