...
max_packets_per_second = 16776192
allowedMaxSizePackets  = 16776192
...
worldId = 0
ip = "192.168.0.102" --189.127.164.20
...
motd = "Sejá bem vindo ao Pokemon HP, Treinador(a)"
displayOnOrOffAtCharlist = false
onePlayerOnlinePerAccount = false
allowClones = true
serverName = "Sapphire"
loginMessage = "Bem-vindo ao Pokemon Hp, torne-se um mestre pokémon. Passe por todas as missões, conclua as quest's e explore nossas cidades. "
