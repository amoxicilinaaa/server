...
function adjustStatus(pk, item, health, vite, conditions)
	...
	elseif (getItemAttribute(ball, "ehshinyditto") == 1) then
		...
		setPlayerStorageValue(pk, 1005, PokeSpAttack + (getPokemonBoost(pk)*10) )
