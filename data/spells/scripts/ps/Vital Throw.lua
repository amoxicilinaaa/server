...
local movestable = getTableMove(cid, spell) --alterado v1.6
	...
	if type(movestable) == 'table' and movestable.f ~= 0 then   --alterado v1.6
            ...
            if getSpecialAttack(cid) and table then
                min = getSpecialAttack(cid) * table * 0.1   --alterado v1.6
            end
    ...
    --- FOCUS ----------------------------------            
    if getPlayerStorageValue(cid, 253) >= 0 and table ~= "" and table ~= 0 then   --alterado v1.6
	    min = min * 2
	    max = max * 2
    ...
    if getPlayerStorageValue(cid, 999457) >= 1 and table ~= "" and table ~= 0 then    --alterado v1.6
