function onCastSpell(cid, var)
    ...
    -- Efeitos de queda sequencial
    for rocks = 1, 20 do
        local delay = rocks * 35

        if spell == "Storm Leaves" then
            addEvent(fall, delay, cid, master, dano, -1, eff2)
        ...
        addEvent(fall, delay, cid, master, dano, -1, eff)
    end

    -- Dano em área com variações específicas
    if spell == "Storm Leaves" then
