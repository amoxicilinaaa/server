function onCastSpell(cid, var)
    ...
    -- Aplica dano tipo ICE na área db1 com efeito visual 17 e condição Slow
    ...
    if isCreature(target) and isInArray({"Dragon", "Flying"}, getPokemonTypeTable(target)) then
        ...
        addEvent(doMoveInArea2, 400, cid, 17, db1, ICEDAMAGE, bonusMin, bonusMax, spell)
    ...
    doMoveInArea2(cid, 17, area, ICEDAMAGE, min, max, spell, ret)
    --]]
