function onCastSpell(cid, var)
    ...
    -- Define dano e efeitos por nome da spell
    ...
    elseif spell == "Fairy Burst" then
        dano = NORMALDAMAGE -- pode ser alterado para FAIRYDAMAGE
        eff  = 644
    ...
    -- Execução sequencial de efeitos com fall
    for rocks = 1, 20 do
    ...
    -- Execução em área com doMoveInArea2
    if spell == "Storm Leaves" then
