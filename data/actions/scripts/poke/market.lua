...
conCart(categoria["Pokeballs"])
	...
	print(conCart(categoria["Pokeballs"]))
	for i = 0, 5311 do
	db.executeQuery("SELECT * FROM `market_items` WHERE i")
	db.executeQuery("UPDATE tabela SET email='fulano@xpto.com.br' WHERE id IN (1);")
