function onUse(cid, item, frompos, item2, topos)
	...
	local msgaviso = "Seu pokemon j� esta com o level m�ximo [100]"
	...
	if string.find(tostring(getItemAttribute(item2.uid, "poke")), "Shiny") then
		doPlayerSendCancel(cid, "Voc� n�o pode usar em pokemns shinys!")
		return true 
	end
	...
	-- else
		-- doPlayerSendCancel(cid, "Voc� precisa ta com pokemon Fora da pokebola")
	-- end
