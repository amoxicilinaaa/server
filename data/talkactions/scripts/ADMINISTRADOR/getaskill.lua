...
function onSay(cid, words, param)
    -- O comando espera o parâmetro no formato: [nome do jogador],[nome do NPC]
    local params = string.explode(param, ",")

    if #params ~= 2 then
        doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Uso correto: /getaskill [nome do jogador],[nome do NPC]")
        return true
    end
    ...
    -- Traduz o nome do NPC para o storage ID
    ...
    local storageValue = getPlayerStorageValue(targetId, storageId)
    local result = "Valor do Storage [" .. storageId .. "] do jogador " .. playerName .. " (task de " .. npcName .. "): " .. tostring(storageValue)
