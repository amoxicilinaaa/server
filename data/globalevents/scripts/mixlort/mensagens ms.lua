MENSAGEM = {
"Aviso: Não se esqueça de baixar o nosso client atualizado em nosso site: http://pokemonhp.xyz/",
"Aviso: Siga o Pokemon Hp nas redes sociais para ficar por dentro das atualizações e novidades! Todas no site: http://pokemonhp.xyz/",
}
...
MENSAGEM3 = {
"Faça uma doação e nos ajude a continuar trazendo diversão para vocês. Site: http://pokemonhp.xyz/",
...
MENSAGEM5 = {
"Curta nossa página do facebook: www.facebook.com/Pokemonhpofc",
}
